 ...
 * 아무 일도 없을 때의 카메라 거리.
 *
 * 시야각 38도에서 이 거리면 화면 세로 절반이 약 1.58이다. 반지름 1인 지구가
 * 그 63%를 차지하고 1.15배 헤일로까지 여유롭게 들어온다. 3.2에서는 세로
 * 절반이 1.10뿐이라 지구가 위아래로 꽉 차고 헤일로가 잘려 나갔다.
 */
export const REST_DISTANCE = 4.6
